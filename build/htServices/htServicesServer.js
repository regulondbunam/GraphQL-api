...
var configApolloServer = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var federatedSchema, htServer, app, limiter, PORT, servExpress;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          htServer = new _apolloServerExpress.ApolloServer({
        ...
        case 7:
          ...
          //Set an enviroment variable for the port (4004 by default)
          PORT = process.env.GRAPHQL_HT_SERVICES_PORT || 4004; //Server start
          servExpress = app.listen(PORT);
          console.log("El servidor esta funcionando en http://localhost:".concat(servExpress.address().port).concat(htServer.graphqlPath));
        case 11:
        case "end":
