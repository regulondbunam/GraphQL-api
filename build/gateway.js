...
app.on('ready', function () {
  ...
  const gateway = new ApolloGateway({
    serviceList: [{ name: "openTools", url: `http://localhost:${OPEN_SERVICES}/graphql` }, { name: "closedTools", url: `http://localhost:${CLOSED_SERVICES}/graphql` }, { name: "htServices", url: `${HT_SERVICES_URL}` }]
  });
