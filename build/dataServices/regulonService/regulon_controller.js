...
class regulonController {
   ...
   *  (by default "false")
   */
  static async getRegulonBy(search, advancedSearch, limit = 0, page = 0, properties = ["_id", "regulator.name", "regulator.conformations.name", "regulator.abbreviatedName"], fullMatchOnly = false) {
