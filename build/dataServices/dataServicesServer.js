...
var configApolloServer = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var federatedSchema, serverDataServices, app, limiter, PORT, servExpress;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          serverDataServices = new _apolloServerExpress.ApolloServer({
          ...
          _context.next = 7;
          return serverDataServices.start();
        case 7:
          ...
          PORT = process.env.GRAPHQL_DATA_SERVICES_PORT || 4003; //Server start
          servExpress = app.listen(PORT);
          console.log("El servidor esta funcionando en http://localhost:".concat(servExpress.address().port).concat(serverDataServices.graphqlPath));
        case 11:
        case "end":
