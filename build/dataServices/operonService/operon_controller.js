...
exports.operonController = void 0;
...
var operonController = exports.operonController = /*#__PURE__*/function () {
  function operonController() {
    _classCallCheck(this, operonController);
  }
  return _createClass(operonController, null, [{
    key: "getOperonBy",
    value: (
     ...
     */
    function () {
      var _getOperonBy = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(search, advancedSearch) {
        var limit,
          page,
          properties,
          fullMatchOnly,
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              properties = _args.length > 4 && _args[4] !== undefined ? _args[4] : ['operon._id', 'operon.name', "transcriptionUnits.name", "transcriptionUnits.promoter.name"];
              ...
              _context.next = 9;
              return _operon_model.Operon.find(filter).sort({
                'operon.name': 1
              }).limit(limit).skip(offset);
            case 9:
              Operons = _context.sent;
              _context.next = 12;
              return _controller_common_functions.commonController.countDocumentsIn(_operon_model.Operon, filter);
            case 12:
              total = _context.sent;
              lastPage = 0;
              if (limit > 0) {
      ...
      function getOperonBy(_x, _x2) {
        return _getOperonBy.apply(this, arguments);
      }
      return getOperonBy;
    }())
  }]);
