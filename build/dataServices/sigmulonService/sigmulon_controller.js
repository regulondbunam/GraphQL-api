...
exports.sigmulonController = void 0;
...
var sigmulonController = exports.sigmulonController = /*#__PURE__*/function () {
  function sigmulonController() {
    _classCallCheck(this, sigmulonController);
  }
  return _createClass(sigmulonController, null, [{
    key: "getSigmulonBy",
    value: (
     ...
     */
    function () {
      var _getSigmulonBy = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(search, advancedSearch) {
        var limit,
          page,
          properties,
          fullMatchOnly,
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              properties = _args.length > 4 && _args[4] !== undefined ? _args[4] : ['sigmaFactor._id', 'sigmaFactor.name', 'sigmaFactor.synonyms', 'sigmaFactor.abbreviatedName'];
              ...
              _context.next = 9;
              return _sigmulon_model.Sigmulon.find(filter).sort({
                'sigmaFactor.name': 1
              }).limit(limit).skip(offset);
            case 9:
              Sigmulons = _context.sent;
              _context.next = 12;
              return _controller_common_functions.commonController.countDocumentsIn(_sigmulon_model.Sigmulon, filter);
            case 12:
              total = _context.sent;
              lastPage = 0;
              if (limit > 0) {
                Math.floor(total / limit), _readOnlyError("lastPage");
              }
      ...
      function getSigmulonBy(_x, _x2) {
        return _getSigmulonBy.apply(this, arguments);
      }
      return getSigmulonBy;
    }())
  }]);
}();
