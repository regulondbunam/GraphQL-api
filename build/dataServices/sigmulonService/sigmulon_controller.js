...
class sigmulonController {
     ...
     *  (by default "false")
     */
    static async getSigmulonBy(search, advancedSearch, limit = 0, page = 0, properties = ['sigmaFactor._id', 'sigmaFactor.name', 'sigmaFactor.synonyms', 'sigmaFactor.abbreviatedName'], fullMatchOnly = false) {
