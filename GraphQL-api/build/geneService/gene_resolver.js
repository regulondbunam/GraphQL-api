...
const geneResolvers = exports.geneResolvers = {
  Query: {
    ...
    getAllGenes: (root, {
      limit,
      page
    }) => _controller_common_functions.commonController.getAll(_gene_model.Gene, limit, page),
    ...
    */
    getGenesBy: (root, {
      ...
      page,
      organismName
    }) => _gene_controller.geneController.getGenesBy(search, advancedSearch, limit, page, organismName)
  }
};